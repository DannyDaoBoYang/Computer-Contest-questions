 ...
 * @author dannyyang
 */
public class Cdcaculator extends javax.swing.JFrame {

    /**
     * Creates new form Cdcaculator
     */
    public Cdcaculator() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        label1.setText("CD Caculator");

        label2.setText("enter initial investment($):");

        label3.setText("enter annual interest rate(%):");

        label4.setText("enter ending value($):");

        label5.setForeground(new java.awt.Color(255, 0, 0));

        button1.setLabel("Caculate");
    ...
    private void button1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button1ActionPerformed
        ...
        label5.setText("The number of year requaire is "+f);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Cdcaculator.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Cdcaculator().setVisible(true);
            }
        });
    }
