...
public class AGeometryProblem {
    ...
    public static void main(String[] args) throws IOException {
        ...
        int L = input.nextInt(); //X
        int W = input.nextInt(); //Y
        int N = input.nextInt();
        edge centers[] = new edge[N];
        int radius = 100;
        for (int i = 0; i < N; i++) {
            centers[i] = new edge(input.nextInt(), input.nextInt());
        }
